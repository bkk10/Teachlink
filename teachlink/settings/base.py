...
# Security settings - OVERRIDE in environment files
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dashboard.context_processor.navigation_context',  # Custom navigation context
            ],
        },
    },
]
...
TEACHLINK_CONFIG = {
    ...
    'INACTIVITY_DAYS_WARNING': 7,
    'INACTIVITY_DAYS_CRITICAL': 14,
}
